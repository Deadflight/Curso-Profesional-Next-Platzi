...
import { CheckIcon, XCircleIcon, PencilIcon } from '@heroicons/react/solid';
                  ...
                  {products?.map((product) => (
                    <tr key={`Product-item-${product.id}`}>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <Link href={`/dashboard/edit/${product.id}`} className="cursor-pointer" passHref>
                          <PencilIcon className="text-gray-600 h-5 w-5" aria-hidden="true" />
                        </Link>
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
